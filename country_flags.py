...
def showMaps():
    ...
    try:
        messagebox.showinfo("Alert","This Is The Flag For Your Country")
    except(KeyError):
        print("Key Error: No Flag For Your Country Is Available")
        messagebox.showinfo("Alert","No Flag For Your Country Available")
